...
public class Console {
	 ...
	 * le try catch permet de vÃ©rifier que l'utilisateur rentre bien une valeur correct
	 * c'est Ã  dire un chiffre
	 *
	 */
	...
	/**
	 *  affiche un message indiquant que le nombre de ligne ne peut pas Ãªtre inferieur ou egal a 0
	 */
	...
	public static Move getMove(String name) {
		...
		System.out.println( name + " à toi de jouer ! ");
		System.out.println("Sélectionne une ligne non vide de la pyramide et retire de une à trois allumettes de cette ligne.");
		...
		System.out.println("Vous avez choisis de retirer à la ligne " + move.ligne + " ce nombre d'allumettes => " + move.nbAllumettes);
		System.out.println();
		System.out.println("-------------------------------------------------------------------------------");
	...
	public static void invalidMove(Move move) {
		...
		System.out.println("Vous ne pouvez pas faire ce mouvement consistant à retirer à la ligne " + move.ligne + " ce nombre => " + move.nbAllumettes +" d'allumettes.");
		System.out.println();
		System.out.println("Rentrez un nombre d'alumettes compris entre 1 et 3 svp");
		System.out.println("Rentrez une ligne où il reste des allumettes.");
		System.out.println();
		System.out.println("-----------------------------------------------------------------------------");
	...
	public static void messageBienvenue() {
		...
		System.out.println("Commencez par définir les différents paramètres de votre partie");
		System.out.println(" ------------------------------------------------------------------");
		System.out.println();
	}
